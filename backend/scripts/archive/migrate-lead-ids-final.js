/**
 * Migration Script: Convert Lead IDs using Temporary Column Approach
 *
 * Strategy:
 * 1. Add temporary column to store new IDs
...
async function migrateLeadIdsWithTempColumn() {
  console.log('========================================');
  console.log('Lead ID Migration Script (Temp Column)');
  console.log('========================================\n');
  ...
  try {
    ...
    await prisma.$executeRawUnsafe(
      `ALTER TABLE leads ADD COLUMN IF NOT EXISTS new_id VARCHAR(20);`
    );
