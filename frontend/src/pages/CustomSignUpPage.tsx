  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.session) {
        ...
        // This shouldn't happen with autoConfirm, but handle gracefully
        setError('Account created but could not sign you in. Please try signing in.');
      }
    } catch (err: any) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-600">Minimum 6 characters</p>
            </div>
